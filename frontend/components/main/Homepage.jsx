        ...
        <div class="row">
          <div class="col-lg-4 col-md-12 p-2">
            <div
              ...
              style="min-height: 400px; background-image: url(https://cdn.shortpixel.ai/client/q_glossy,ret_img/https://8am.af/wp-content/uploads/2020/09/GHANI.jpg); background-position: center; background-size: cover;"
            >
              <div
              ...
              >
                ...
                <h3 class="h6">
                  <a href="#" class="text-white" style="line-height: 1.6;">
                ...
                <div class="mt-2">
                  <a
                    href="#"
                    class="pl-2 text-white mr-2"
                    style="border-left: 3px solid #9B5DE5;"
                  >
                    <small>Sara Faizi</small>
                  </a>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 p-2">
            <div class="p-3 border" style="box-shadow: 0 0 20px #eee;">
              <div class="border-bottom mb-3 pb-3 px-2 d-flex justify-content-between">
                <div class="d-flex align-items-center">
                  ...
                  >
                    <g>
                      <path
                        d="M495,103.513V95.5c0-21.78-17.72-39.5-39.5-39.5h-416C17.72,56,0,73.72,0,95.5v303.997c0,0.003,0,0.005,0,0.008
          ...
          c2.187,0,4.349-0.953,5.822-2.764C275.075,325.77,412.962,188.308,480,121.551V399.5C480,413.01,469.009,424,455.5,424z"
                      />
                      <path
                        d="M103.5,199c21.78,0,39.5-17.72,39.5-39.5S125.28,120,103.5,120S64,137.72,64,159.5S81.72,199,103.5,199z M103.5,135
          c13.509,0,24.5,10.99,24.5,24.5S117.009,184,103.5,184S79,173.01,79,159.5S89.991,135,103.5,135z"
                  ...
                  <a
                    href="#"
                    style="color: #9B5DE5; font-size: 16px;"
              ...
              <div class="mt-3 pb-3 border-bottom">
                ...
                >
                  Bests of Leonel Messi (Videos, Images & Quotes)
                </a>
                <div class="d-flex align-items-start justify-content-between mt-2">
                  ...
                  <img
                    ...
                    style="width: 110px;"
                    src="https://media.gettyimages.com/photos/lionel-messi-and-marcandre-ter-stegen-of-fc-barcelona-waits-in-the-picture-id1266763488?k=6&m=1266763488&s=612x612&w=0&h=8vxz9HfQVfrff5N7d1lBVxtLamRQGK3J3lyHkUuuIiw="
                    alt=""
                  />
                </div>
              </div>
          ...
          <div class="col-lg-4 col-md-6 p-2">
            <div class="p-3 border h-100" style="box-shadow: 0 0 20px #eee;">
              <div class="border-bottom mb-3 pb-3 px-2 d-flex justify-content-between">
                <div class="d-flex align-items-center">
                  <svg
                    height="25px"
          ...
          c13.509,0,24.5,10.99,24.5,24.5S117.009,184,103.5,184S79,173.01,79,159.5S89.991,135,103.5,135z"
              ...
              <div class="mb-3">
                <img
                  class="w-100 mb-3"
                  src="https://media.gettyimages.com/photos/on-the-voting-day-portrait-of-the-candidate-dr-abdullah-his-finger-is-picture-id1179614315?k=6&m=1179614315&s=612x612&w=0&h=NIBfEBJ3BC82RKAzO6cckN2GF3WL9V6dxzzuG8_NWRc="
                  alt=""
                />
                <div class="d-flex align-items-center">
                  {/* <svg height="10px" class="mr-1" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
              viewBox="0 0 300.988 300.988" style="enable-background:new 0 0 300.988 300.988;" xmlSpace="preserve">
            <g>
              <g>
